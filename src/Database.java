        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(FILE_PATH))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (data.length >= 3) {
                    ...
                    Animal animal;
                    switch (className) {
                        case "Animals.Dog" -> animal = new Dog(name, skills);
                        case "Animals.Cat" -> animal = new Cat(name, skills);
                        case "Animals.Hamster" -> animal = new Hamster(name, skills);
                        case "Animals.Donkey" -> animal = new Donkey(name, skills);
                        case "Animals.Horse" -> animal = new Horse(name, skills);
                        default -> {
